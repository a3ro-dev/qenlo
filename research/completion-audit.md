...
The requested full Cartesian experiment matrix is not complete and cannot be represented as such. Its absent cells are part of the scientific result: native WGPU was unavailable on the budgeted A6000 image, while rerunning all dimensions, distributions, batches, and HNSW expansions would exceed the bounded campaign and the available prepared datasets. The paper narrows every conclusion accordingly. The static 4,096-row rule has measurable cell-level regret, but no frozen calibrated policy has been evaluated; H6 remains open.
